...
typedef NS_ENUM(NSInteger, Error)
{
    ...
    Error_AMOUNT_OUT_OF_LIMIT,//add 2016-08-23 
};
...
typedef NS_ENUM(NSInteger, Display)
{
    ...
    Display_CARD_REMOVED,//add 2016-08-29
};
...
- (void)isCardExist:(NSInteger)timeout withResultBlock:(void (^)(BOOL))isCardExistBlock;//add 2016-08-23 icccard
@end
